...
class DataManager:
    ...
    def __init__(self, data_path: str):
        ...
        self.ban_file = os.path.join(data_path, "user_ban.json")
    ...
    def load_ban_data(self) -> Dict[str, Any]:
        """
        从文件加载用户数据
        :return: 数据字典
        """
    ...
    def save_ban_data(self, data: Dict[str, Any]) -> bool:
        """
        保存用户数据到文件
        :param data: 数据字典
        :return: 是否成功
    ...
    def update_ban_data(self, user_name: str, ban_data: Dict[str, Any]) -> bool:
        """
        更新指定用户的数据
        :param user_name: 用户名
        :param ban_data: 被ban数据
        :return: 是否成功
        """
        all_data = self.load_ban_data()
        ...
        return self.save_ban_data(all_data)
    ...
    def get_ban_data(self, user_name: Optional[str] = None) -> Dict[str, Any]:
        """
        获取站点数据
        :param user_name: 用户名，如果为None则返回所有用户数据
        :return: 站点数据
        """
        all_data = self.load_ban_data()

        if user_name:
            return all_data.get(user_name, {})
        return all_data
